...
-(void) applyDynamics
{
    ...
    UITapGestureRecognizer *tapGest = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(hideNotification)];
...
-(void) setupNotificationType
{
    ...
    //self.backgroundColor=[UIColor colorWithHexString:@"00a54F"];
}
...
-(void) setup
{
    ...
    titleLabel.font = [UIFont fontWithName:@"Junegull-Regular" size:17];
    //titleLabel.font =[UIFont fontWithName:@"SEOptimistBlack" size:17.0];
