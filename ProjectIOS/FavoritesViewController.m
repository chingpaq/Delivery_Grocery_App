...
-(void)viewDidAppear:(BOOL)animated{
    self.favoritesData = [API getFavorites:nil];
//    self.addProductButton.layer.cornerRadius= 41;
//    self.addProductButton.clipsToBounds=YES;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"showFavoritesItemDetail"]) {
